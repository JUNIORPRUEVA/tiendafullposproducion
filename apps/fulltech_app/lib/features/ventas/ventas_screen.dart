  ...
  Widget build(BuildContext context) {
    final mockSales = List.generate(
      ...
      (i) => SaleModel(
        ...
        items: [
          SaleItemModel(id: 'I-$i-1', productName: 'Producto A', qty: 1, price: 10, lineTotal: 10),
          SaleItemModel(id: 'I-$i-2', productName: 'Producto B', qty: 1, price: 5.5, lineTotal: 5.5),
        ],
      ),
    );
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Ventas: ${mockSales.length} · Total: \$${totalDay.toStringAsFixed(2)}'),
                        ],
                      ),
                    ),
                  ],
