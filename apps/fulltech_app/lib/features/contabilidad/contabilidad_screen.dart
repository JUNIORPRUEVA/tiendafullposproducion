...
class ContabilidadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final entries = <LedgerEntryModel>[
      LedgerEntryModel(id: 'L-1', type: 'income', description: 'Venta mostrador', amount: 120.50, date: DateTime.now()),
      LedgerEntryModel(id: 'L-2', type: 'expense', description: 'Compra insumos', amount: 35.20, date: DateTime.now().subtract(const Duration(hours: 4))),
      LedgerEntryModel(id: 'L-3', type: 'income', description: 'Servicio técnico', amount: 80.00, date: DateTime.now().subtract(const Duration(days: 1))),
      LedgerEntryModel(id: 'L-4', type: 'expense', description: 'Transporte', amount: 12.75, date: DateTime.now().subtract(const Duration(days: 1, hours: 3))),
    ];
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Balance: \$${balance.toStringAsFixed(2)}', style: Theme.of(context).textTheme.titleSmall),
                        ],
                      ),
                    ),
                  ],
